...
class ViewBuilder:
    ...
    def build_about_view(app, parent_frame):
        ...
        btn_gh = ctk.CTkButton(links, text="GitHub", font=("Segoe UI", 15, "bold"), height=48, width=120, fg_color="#282A2C", hover_color="#383A3C", text_color=MD_TEXT, corner_radius=24, command=lambda: webbrowser.open_new_tab("https://github.com/bluefalcon2270/bluefalcon-network-toolkit"))
